  ...
  return (
    <section className="py-16 bg-secondary relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-green-light/20 rounded-full blur-3xl" />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
          ...
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-secondary-foreground mb-4">
              Ready to enjoy fresh, healthy meals delivered daily?
            </h2>
            <p className="text-secondary-foreground/80 text-lg">
              Join hundreds of happy customers in Bellandur who trust MealNest for
              their daily meals.
            </p>
          </div>
