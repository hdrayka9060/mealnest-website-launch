  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-md border-t border-border md:hidden z-50">
      <a
        ...
        className="flex items-center justify-center gap-2 w-full py-4 rounded-full bg-secondary text-secondary-foreground font-semibold text-lg shadow-lg hover:bg-green-light transition-colors"
      >
